...
\begin{center}
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node at (0,-17) {\includegraphics[width=18cm]{peaks.png}};
...
\begin{center}
  \begin{figure}[!h]
  \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=0.6\textwidth]{matlab.png}};
    \node at (5,3) {Console};
...
\begin{center}
  \includegraphics[width=6cm]{fit.png}
\end{center}
